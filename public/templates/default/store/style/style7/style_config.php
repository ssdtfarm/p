...
<marquee scrolldelay="1" scrollamount="1" direction="up" style="text-align:left;padding-top:5px;padding-left:5px;width:180px;height:60px;">
 <a target="_blank" href="$site_url">Shop旗舰店</a>田园家具 田园衣柜 衣橱 推拉门 三门衣柜 实木衣柜 . </marquee>
							</td>
						</tr>
					</tbody>
				</table>
