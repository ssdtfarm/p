define(function(require, exports, module) {
     ...
     *  date: 2015-11-17
     *  what modified: the rules of the password
     *
     */  
    ...
    function setPass(obj) {
        ...
        obj.on('blur', function() {
            ...
            if (val.length > 20) {
                ...
                level.hide();
                showTip(self, '请设置6-20位数字、字母或符号的密码（不包括空格）', 'error');
                return;
            }
        ...
        obj.on('keyup', function() {
            ...
            // 非汉字|数字|大小写字母|空格，即符号
            if (/[^(\u4E00-\u9FA5\uF900-\uFA2D\uFE30-\uFFA0|\s|0-9|a-z|A-Z)]/.test(val)) {
                levelCount++;
            }
            // if(/[-_]/.test(val)) {
            //     levelCount++;
