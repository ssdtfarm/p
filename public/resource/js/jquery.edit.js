$(document).ready(function(){
	...
	$('a[nc_type="inline_edit"]').click(function(){
		...
		if(data == 'true')
			{
				if (i_name == 'gc_index_show' || i_name=='gc_show' || i_name=='bl_state' || i_name=='bl_quota_state'){
					if(i_val == 0)
					{
...
// alert('操作失败');
	...
	// $('img[nc_type="inline_edit"]').parent().attr('title','可编辑');
